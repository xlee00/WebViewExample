...
public final class JumpingBeans {
     ...
     * {@link net.frakbot.jumpingbeans.JumpingBeans.Builder} applied to the
     * provided {@code TextView}.
     * 
     * @param textView
    ...
    private static CharSequence appendThreeDotsEllipsisTo(TextView textView) {
        ...
        if (!endsWithThreeEllipsisDots(text)) {
            text = new SpannableStringBuilder(text).append(THREE_DOTS_ELLIPSIS); // Preserve
                                                                                 // spans
                                                                                 // in
                                                                                 // original
                                                                                 // text
    ...
    private static boolean endsWithThreeEllipsisDots(@NonNull CharSequence text) {
        ...
        return TextUtils.equals(text.subSequence(text.length() - THREE_DOTS_ELLIPSIS_LENGTH, text.length()),
                THREE_DOTS_ELLIPSIS);
    }
     ...
     * JumpingBeans jumpingBeans = JumpingBeans.with(myTextView).appendJumpingDots().setLoopDuration(1500).build();
     * </pre>
     */
    public static class Builder {
        ...
        private JumpingBeansSpan[] getJumpingBeansSpans(SpannableStringBuilder sbb) {
            ...
            for (int pos = startPos; pos < endPos; pos++) {
                JumpingBeansSpan jumpingBean = new JumpingBeansSpan(textView, loopDuration, pos - startPos,
